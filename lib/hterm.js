...
import isCommands from './utils/keymaps';
...
hterm.Keyboard.prototype.onKeyDown_ = function (e) {
  ...
  const isCmd = isCommands(e);
  if (isCmd) {
    if (CommandRegistry.getCommand(isCmd)) {
      CommandRegistry.exec(isCmd, e);
    }
  }
  if (e.altKey || e.metaKey || isCmd) {
