...
import NavComponent_ from './navComponent';
...
class HeaderComponent extends React.PureComponent {
  ...
  render() {
    ...
    return (
      ...
      >
        {!isMac && (
          <div className={`header_windowHeader ${props.tabs.all.length > 1 ? 'header_windowHeaderWithBorder' : ''}`}>
            {hambMenu && (
              <svg
